...
const APP_LAYOUT_ALPHA_TEMPLATE = `
  <div id="__layout">
...
const APP_LAYOUT_ALPHA_STYLES_PRINT = `
  :host {
...
export class AppLayoutAlphaElement extends HTMLElement {
  constructor() {
    ...
    styleElement.textContent = APP_LAYOUT_ALPHA_STYLES
    this.shadowRoot.appendChild(styleElement)
    styleElement = document.createElement('style')
    styleElement.setAttribute('media', 'print')
    styleElement.textContent = APP_LAYOUT_ALPHA_STYLES_PRINT
    this.shadowRoot.appendChild(styleElement)
    const templateElement = document.createElement('template')
    templateElement.innerHTML = APP_LAYOUT_ALPHA_TEMPLATE
    ...
    const frags = createLinkStlesheets(
      { document },
      this.localName,
      APP_LAYOUT_ALPHA_STYLES_EXTERNAL,
    )
    this.shadowRoot.appendChild(frags)
