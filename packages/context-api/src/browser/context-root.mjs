import { ContextRequestEvent } from './event.mjs'

/**
 * Copy-Pasta from @lit/context@1.1.6
 * https://github.com/lit/lit/blob/43c6168a/packages/context/src/lib/context-root.ts
 */
...
export class ContextRoot {
  #pendingContextRequests = new Map()
