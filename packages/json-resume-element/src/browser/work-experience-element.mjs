...
export class WorkExperienceElement extends HTMLElement {
  ...
  connectedCallback() {
    [...ATTRIBUTES].forEach((attributeName) => {
      console.log(`connectedCallback loop ${attributeName}`)
    ...
    switch(attributeName) {
      ...
      case 'dateStart':
        ...
        if (attributeValue) {
          ...
          console.log(`connectedCallback for ${attributeName} ${attributeValue}`, initialDateElement)
  ...
  attributeChangedCallback(name, oldValue, newValue) {
    console.log(`${this.constructor.name}::attributeChangedCallback`, { name, oldValue, newValue })
